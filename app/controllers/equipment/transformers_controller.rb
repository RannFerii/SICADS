class Equipment::TransformersController < ApplicationController
  ...
  private
    ...
    def transformer_params
      params.require(:transformer).permit(:nomenclatura, :transformador_type, :phase_type, :numero_activo_fijo, :fecha_puesta_servicio, phases_attributes:[:id, :fase, :marca, :num_serie, :fecha_fabricacion, :impedencia_max_hx_capacidad, :impedancia_max_hy_capacidad, :impedancia_max_xy_capacidad, :relacion_transformacion, :capacidad, :transformacion, :masa_embarque, :esquema_nucleo, :total_aceite, :sistema_enfriamiento, :mampara, :cambiador_taps,:num_taps, :sistema_contra_incendios, :fosa_captadora_aceite, :tension_sistema, :capacitancia, :clase_exactitud, :tipo_expancion_aceite, :tipo_envolvente, :mva, :kv_nom_at, :kv_nom_bt, :kv_nom_terciario, :porcentage_z, :fecha_puesta_servicio,:_destroy, trans_mouthpieces_attributes: [:id, :_destroy, :marca, :tipo, :num_serie, :kv, :amp,  :fecha_fabricacion]])
    end
end
